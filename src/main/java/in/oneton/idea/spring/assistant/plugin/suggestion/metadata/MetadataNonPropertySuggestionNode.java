        ...
        if (haveMoreSegments) {
            ...
            if (hasChildren()) {
                ...
                if (childLookup.containsKey(currentPathSegment)) {
                    ...
                    if (child instanceof MetadataPropertySuggestionNode && deepestMatch == null) {
                        SuggestionNodeType suggestionNodeType = ((MetadataPropertySuggestionNode) child).getProperty().getSuggestionNodeType(module);
                        if (SuggestionNodeType.MAP.equals(suggestionNodeType)) {
                            deepestMatch = Collections.emptyList();
                        }
                    }
                }
